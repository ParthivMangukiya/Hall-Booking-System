...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2017 at 08:52 PM
...
INSERT INTO `tblbooking` (`id`, `userEmail`, `HallId`, `FromDate`, `ToDate`, `message`, `Status`, `PostingDate`) VALUES
...
INSERT INTO `tblcities` (`id`, `CityName`, `CreationDate`, `UpdationDate`) VALUES
(1, 'Baroda', '2017-06-18 16:24:34', '2017-10-25 17:02:45'),
(8, 'surat', '2017-10-25 16:50:58', NULL),
(9, 'Bhavnagar', '2017-10-25 17:05:56', NULL);
...
CREATE TABLE `tblhalls` (
  `id` int(11) NOT NULL,
  `HallName` varchar(150) DEFAULT NULL,
  `CityId` int(11) DEFAULT NULL,
  `HallOverview` longtext,
  `PricePerDay` int(11) DEFAULT NULL,
  `HallType` varchar(100) DEFAULT NULL,
