...
$sql="update tblhalls set Vimage5=:vimage where id=:id";
...
<head>
	...
	<title>Hall Rental Portal | Admin Update Image 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Hall Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Hall Image 5 Details</div>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from tblhalls where tblhalls.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
