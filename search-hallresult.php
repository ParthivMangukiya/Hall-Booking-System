...
$sql = "SELECT id from tblhalls where tblhalls.CityId=:city and tblhalls.HallType=:halltype";
...
$sql = "SELECT tblhalls.*,tblcities.CityName,tblcities.id as bid  from tblhalls join tblcities on tblcities.id=tblhalls.CityId where tblhalls.CityId=:city and tblhalls.HallType=:halltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':city',$city, PDO::PARAM_STR);
$query -> bindParam(':halltype',$halltype, PDO::PARAM_STR);
$query->execute();
