...
<title>Hall Rental Portal</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find the best hall for you.</h1>
            <p>We have more than a hundred halls for you to choose. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>HallForYou</span></h2>
    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New Hall</a></li>
        </ul>
      </div>
...
<p><?php echo substr($result->HallOverview,0,70);?></p>
</div>
</div>
</div>
<?php }}?>
